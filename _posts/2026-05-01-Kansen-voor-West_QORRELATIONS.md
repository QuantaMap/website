...
- [**QuantaMap**](https://www.linkedin.com/company/quantamap) develops technology for imaging and analysing defects in quantum chips, and leads the industrialisation and value-chain integration effort.
- [**Orange Quantum Systems**](https://orangeqs.com/) builds systems for electrical testing of quantum chips.
- [**VSL**](https://www.vsl.nl/en/), the Dutch national metrology institute, works on precision measurement methods, validation, and standardisation.
- [**TNO**](https://www.tno.nl/en/) contributes research and development on the chip technology itself.
...
The project draws on expertise already present in adjacent sectors — semicon, mechatronics, chip fabrication — and is supported through Kansen voor West and funding from the European Union, which the partners consider essential for collaboration at this scale in capital-intensive, long-horizon deep tech.
...
- **Region:** South Holland / West Netherlands
- **Lead partner:** QuantaMap
- **Consortium:** QuantaMap, Orange Quantum Systems, TNO, VSL
- **Total project size:** €2,000,448.59

**Project goal:** Development of a scalable test and measurement process for superconducting quantum chips, enabling earlier defect detection and more reliable, lower-cost production. The consortium aims to develop the technology into a control point within the international quantum value chain and strengthen South Holland's competitive position.

[Official announcement]()

![Co-funded by the European Union](/assets/images/news/2026-05-01-Co-fundedbytheEU.png)
